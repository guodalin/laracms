                ...
                <div class="layui-col-md3">
                    <div class="fly-panel">
                        ...
                        <div class="fly-panel-main">
                            ...
                            <a href="{{ route('article.child',[request('navigation',0),$child->id]) }}" rel="nofollow"
                                class="fly-category @if(request('childarticleCategory',0)==$child->id)fly-category-this @endif">{{$child->name}}</a>
                            @endforeach
